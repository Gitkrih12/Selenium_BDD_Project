...
public class FFSProfessionalStepDef extends FFSProfessionalPage {
    ...
    @Then("user able to view the {string}, {string}, {string} and {string} column fields in FFS Professional pend bucket")
    public void user_able_to_view_the_and_column_fields_in_ffs_professional_pend_bucket(String netPayAmt, String receivedDate, String age, String assignedTo) {
    ...
    @Then("user able to view the search fields under Received Date, Age and Assigned To column fields")
    public void user_able_to_view_the_search_fields_under_received_date_age_and_assigned_to_column_fields() throws InterruptedException {
        verifyReceivedDateSearchField();
        verifyAgeSearchField();
        verifyAssignedToSearchField();
    }
