...
public class ExcelUtils extends SeleniumUtils {
	...
	public void setCellData(String path, String sheetName,int rownum,int colnum,String data) throws IOException, InterruptedException {
		sheet=wb.getSheet(sheetName);
