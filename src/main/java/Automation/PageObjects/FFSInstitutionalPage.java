...
public class FFSInstitutionalPage extends SeleniumUtils {
    ...
    String lstColumnFields = "//ag-grid-angular[@id='Pend_FFS_Institutional']//div[@class='ag-header-cell-label']//span[text()]";
    String lstQueues = "//div[@id='nav-tab']//button";
    String txtSearchFields = "//ag-grid-angular[@id='Pend_FFS_Institutional']//div[@class='ag-header-cell-label']//span[text()]//following::div[1]//input[@type='text']";
    String txtMemberId = "//*[@id='Pend_FFS_Institutional']//input[@aria-label='Member ID Filter Input']";
    String eleMemberId = "(//*[@id='Pend_FFS_Institutional']//div[@col-id='subscriberId']//span[@class='ag-cell-value'])[1]";
    String eleTotalMemberIdRecords = "//*[@id='Pend_FFS_Institutional']//div[@col-id='subscriberId']//span[@class='ag-cell-value']";
    String eleTotalResults = "//*[@id='Pend_FFS_Institutional']//span[@class='ag-paging-row-summary-panel']";
    String elePaginationDescription = "//*[@id='Pend_FFS_Institutional']//span[@class='ag-paging-description']";
