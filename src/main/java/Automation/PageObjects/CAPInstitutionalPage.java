...
public class CAPInstitutionalPage extends SeleniumUtils {
    ...
    String lstColumnFields = "//ag-grid-angular[@id='Pend_CAP_Institutional']//div[@class='ag-header-cell-label']//span[text()]";
    String lstQueues = "//div[@id='nav-tab']//button";
    String txtSearchFields = "//ag-grid-angular[@id='Pend_CAP_Institutional']//div[@class='ag-header-cell-label']//span[text()]//following::div[1]//input[@type='text']";
    String txtMemberId = "//*[@id='Pend_CAP_Institutional']//input[@aria-label='Member ID Filter Input']";
    String eleMemberId = "(//*[@id='Pend_CAP_Institutional']//div[@col-id='subscriberId']//span[@class='ag-cell-value'])[1]";
    String eleTotalMemberIdRecords = "//*[@id='Pend_CAP_Institutional']//div[@col-id='subscriberId']//span[@class='ag-cell-value']";
    String eleTotalResults = "//*[@id='Pend_CAP_Institutional']//span[@class='ag-paging-row-summary-panel']";
    String elePaginationDescription = "//*[@id='Pend_CAP_Institutional']//span[@class='ag-paging-description']";
    ...
    String tabCAPInstitutionalDefault = "//div[@class='col ng-star-inserted default-tab' and contains(text(),'CAP Institutional')]";
    ...
    public void clickOnCAPInstitutionalClaim() throws InterruptedException {
        threadSleep(5000);
        clickElement(eleClaimNumber);
    }

    public void enterClaimNumberInPendCAPInstitutionalSearchField() throws InterruptedException {
        expClaimNumber = prop.getProperty("capInstitutionalClaimNumber");
        findElementAndSendKeys(findElementByXpath(txtClaimNumber), expClaimNumber);
        threadSleep(1000);
        sendKeysUsingKeyboardInput(txtClaimNumber);
    }
    public void clickOnCAPInstitutionalDefaultTab(){
        clickElement(tabCAPInstitutionalDefault);
    }

    //Scenario: Verify color code for corrected claims in CAP Institutional page
    public void enterCorrectedClaimNumberInCAPInstitutionalSearchField() throws InterruptedException {
        expClaimNumber = prop.getProperty("capInstitutionalCorrectedClaimNumber");
        findElementAndSendKeys(findElementByXpath(txtClaimNumber), expClaimNumber);
        threadSleep(1000);
        sendKeysUsingKeyboardInput(txtClaimNumber);
    }
    ...
    public void enterCOBInMemberHouseClaimNumber() throws InterruptedException {
        expClaimNumber = prop.getProperty("capInstitutionalCobInMemberHouse");
        findElementAndSendKeys(findElementByXpath(txtClaimNumber), expClaimNumber);
        threadSleep(1000);
        sendKeysUsingKeyboardInput(txtClaimNumber);
    }
    ...
    public void enterCOBNotInMemberHouseClaimNumber() throws InterruptedException {
        threadSleep(30000);
        expClaimNumber = prop.getProperty("capInstitutionalCobNotInMemberHouse");
        findElementAndSendKeys(findElementByXpath(txtClaimNumber), expClaimNumber);
        threadSleep(1000);
        sendKeysUsingKeyboardInput(txtClaimNumber);
    }
